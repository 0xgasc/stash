    ...
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50">
      <div className="bg-gray-950 p-8 max-w-md w-full mx-4 border border-gray-800 relative">
        ...
        <div className="space-y-3">
          <button
            onClick={() => signInWithGoogle(claimToken)}
            className="w-full bg-white text-black font-medium py-3 px-6 flex items-center justify-center gap-3 hover:bg-gray-200 transition-colors"
          >
          ...
          <button
            onClick={() => signInWithGithub(claimToken)}
            className="w-full bg-gray-900 text-white font-medium py-3 px-6 flex items-center justify-center gap-3 hover:bg-gray-800 border border-gray-700 transition-colors"
          >
